...
namespace input
{
    ...
    int hand_offset_x, hand_offset_y;
    ...
    bool init()
    {
        ...
        hand_offset_x  = data::cfg["custom"]["cursor_pointer_x"].asInt();
        hand_offset_y  = data::cfg["custom"]["cursor_pointer_y"].asInt();
    ...
    std::pair<double, double> get_xy()
    {
        ...
        if (GetCursorPos(&point))
        {
            ...
            fy = std::min(fy, 1.0);
            fy = std::max(fy, 0.0);
            x = -97 * fx + 44 * fy + hand_offset_x;
            y = -76 * fx - 40 * fy + hand_offset_y;
        }
#endif
    ...
    void drawDebugPanel()
    {
        ...
        result << "LStick : "
               << "( " << leftstick_axis.x << "," << leftstick_axis.y << " )" << std::endl;
        result << "RStick : "
               << "( " << rightstick_axis.x << "," << rightstick_axis.y << " )" << std::endl;
        result << "LTrigger : " << left_trigger_axis << std::endl;
        result << "RTrigger : " << right_trigger_axis << std::endl;
        result << "DPad : "
               << "( " << dpad_axis.x << "," << dpad_axis.y << " )" << std::endl;
